  ...
  return (
    <WavyBackground>
      ...
      <div>
        ...
        <h2 className="text-3xl font-bold my-4">
          2) ***Quiz starts only when Minimum 2 users are Ready to play***
        </h2>
        <h2 className="text-3xl font-bold my-4">
          3) The user who answers a question fastest and correctly will be
          marked with a point.
        </h2>
        <h2 className="text-3xl font-bold my-4">
          4) The user who scored the fastest correct answer is notified to
          everyone.
        </h2>
        <h2 className="text-3xl font-bold my-4">
          5) Immediately after someone answers the question, a new question will
          be generated.
        </h2>
        <h2 className="text-3xl font-bold my-4">
          6) There will be a timer for 20 seconds after which a new question
          pops up
        </h2>
      </div>
